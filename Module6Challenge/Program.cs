...
class Program
{
    static void Main(string[] args)
    {
        ...
        library.AddBook(new Book("The Great Gatsby", "F. Scott Fitzergerald", "9780743273565"));
        library.AddBook(new Book("To Kill a Mocking Bird", "Harper Lee", "9780446310789"));
        ...
        Console.WriteLine("\nBorrowing books:");
        member1.BorrowBook(library, "97807743273565");
